...
export function VariantSelector({
  ...
  const selectedVariantInventory = (selectedVariant !== undefined) ? selectedVariant?.quantityAvailable : 0;
  const inventoryLabel = (selectedVariantInventory < 5)
    ? selectedVariantInventory < 1 ? "Out of Stock" : "Less than 5 left"
    : "In Stock";
